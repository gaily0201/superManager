						...
						<c:forEach items="${userList}" var="user" varStatus="vs">
							...
							<tr>
								...
								<!-- <td><a title="发送电子邮件" style="text-decoration:none;cursor:pointer;" onclick="sendEmail('${user.EMAIL }');">${user.EMAIL }&nbsp;<i class="icon-envelope"></i></a></td>
								 -->
								 <td><a title="发送电子邮件" style="text-decoration:none;cursor:pointer;" onclick="javascript:alert('预留功能,待开发');">${user.EMAIL }&nbsp;<i class="icon-envelope"></i></a></td>
								</c:if>
								<c:if test="${QX.FX_QX != 1 }">
								...
								<td style="width: 60px;">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<a class='btn btn-mini btn-warning' title="发送短信" onclick="javascript:alert('预留功能,待开发');"><i class='icon-envelope'></i></a>
										</c:if>
		...
		<table style="width:100%;">
			<tr>
				<td style="vertical-align:top;">
					...
					<c:if test="${QX.FX_QX == 1 }">
					<a title="批量发送电子邮件" class="btn btn-small btn-info" onclick="javascript:alert('批量发送，预留功能,待开发');"><i class="icon-envelope-alt"></i></a>
					</c:if>
					<c:if test="${QX.FW_QX == 1 }">
					<a title="批量发送短信" class="btn btn-small btn-warning" onclick="javascript:alert('批量发送，预留功能,待开发');"><i class="icon-envelope"></i></a>
					</c:if>
					<c:if test="${QX.del == 1 }">
