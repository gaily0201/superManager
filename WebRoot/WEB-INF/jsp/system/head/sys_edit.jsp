			  ...
			  <div id="profile3" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><input type="text" name="WXURL" id="WXURL" value="http://gaily0201.oicp.net/superManager/weixin/index/" disabled="disabled"  style="width:90%" title="URL(服务器地址)必须是域名，ip地址验证通不过"/></td>
					</tr>
					<tr>
