...
<div id="page-content">
  <div class="row-fluid">
					...
					<c:forEach items="${roleList}" var="role" varStatus="vs">
						<td style="width:100px;" class="center">
							 <div class="btn-group">
				                <button class="btn 
					                <c:choose>
										<c:when test="${pd.ROLE_ID == role.ROLE_ID}">btn-warning</c:when>
										<c:otherwise>btn-info</c:otherwise>
									</c:choose>
				                " onclick="window.location.href='role.do?ROLE_ID=${role.ROLE_ID }'">${role.ROLE_NAME }</button>
				                ...
				                <button data-toggle="dropdown" class="btn 
				                 ...
				                 dropdown-toggle"><i class="icon-angle-down"></i></button>
				                <ul class="dropdown-menu">
				                  <li><a onclick="delRole('${role.ROLE_ID }','z','${role.ROLE_NAME }');">删除</a></li>
				                  <li class="divider"></li>
				                  <li><a href="javascript:alert('预留功能,待开发');">修改</a></li>
				                </ul>
				              </div>
						</td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function showRolePage(ROLE_ID){
			href="role.do?ROLE_ID="+ROLE_ID;
		}
